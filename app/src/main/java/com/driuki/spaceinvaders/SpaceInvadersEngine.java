...
public class SpaceInvadersEngine extends SurfaceView implements Runnable {
    ...
    // A boolean which we will set and uset
    ...
    private void update() {
        ...
        // Did an invader bump into side of the screen
        ...
        for (int i = 0; i < numInvaders; i++) {
            if (invaders[i].getVisibility()) {
                ...
                if (invaders[i].takeAim(playerShip.getX(), playerShip.getLength())) {
                    if (invadersBullets[nextBullet].shoot(invaders[i].getX() + invaders[i].getLength() / 2, invaders[i].getY(), bullet.DOWN)) {
                        ...
                        if (nextBullet == maxInvaderBullets) {
                            // This stops the firing of another bullet until one completes ist journey
                ...
                // If that move caused them to bump the scree change bumped to true
        ...
        if (bumped) {
            ...
            // By making the sounds more frequient
        ...
        // Has an alien bullet hit a shelter rock
        for (int i = 0; i < invadersBullets.length; i++) {
            if (invadersBullets[i].getStatus()) {
    ...
    private void draw() {
        ...
        if (ourHolder.getSurface().isValid()) {
            ...
            canvas.drawText("Score: " + score + "   Lives: " + lives, 20, 100, paint);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        switch (motionEvent.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                // To detect the lower touch of the screen
