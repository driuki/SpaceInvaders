...
public class PlayerShip {
    ...
    // Theplayer ship will be represented by a Bitmap
    ...
    // This will hold the px/s speed that the ship will move
    ...
    public PlayerShip(Context context, int screenX, int screenY) {
        ...
        // Stretch the bitmap to a siz appropriate for the screen resolution
        bitmap = Bitmap.createScaledBitmap(bitmap,
                (int) (length),
                (int) (height),
                false);

        // How fast is the spaceship in px/s goes
        shipSpeed = 350;
    ...
    // It determiness if the player ship needs to move and changes the coordinates
